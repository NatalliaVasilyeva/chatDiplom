...
<div id="footer" style="display:none">
	<footer class="mb-0 py-4 "
		...
		<div class="container text-center">
			<spring:message code="footer.copyright" var="copyright"/>
			<small style="color:black">${copyright}, 2019</small>
		</div>
	</footer>
</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<spring:message code="footer.profile" var="profile"/>
			...
			<div class="modal-footer">
				<spring:message code="footer.close" var="close"/>
